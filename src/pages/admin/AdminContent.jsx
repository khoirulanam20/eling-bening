                ...
                <section className="relative h-[600px] flex items-center justify-center text-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-white max-w-4xl px-4">
                        <div className="flex justify-center mb-6">
                            <span className="px-6 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[10px] font-bold tracking-[0.3em] uppercase">
                                {h.heroBadge}
                            </span>
                        </div>
                        <h1 className="text-4xl md:text-6xl font-bold mb-8 font-serif leading-[1.1]">
                            {h.heroTitleLine1} <br />
                            <span className="text-green-400 drop-shadow-[0_2px_10px_rgba(74,222,128,0.3)]">{h.heroTitleLine2}</span>
                        </h1>
                        <p className="text-base md:text-lg mb-10 font-light max-w-2xl mx-auto leading-relaxed">
                            {h.heroSubtitle}
                        </p>
                        <div className="flex gap-4 justify-center">
                            <button className="bg-eling-red text-white py-4 px-10 rounded-full font-bold text-sm transition shadow-2xl">{h.ctaPrimary}</button>
                            <button className="backdrop-blur-md bg-white/10 text-white border border-white/30 py-4 px-10 rounded-full font-bold text-sm transition shadow-2xl">{h.ctaSecondary}</button>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-24 px-8 bg-white">
                    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2 relative">
                            ...
                            <img src="/images/generated/resort.png" className="rounded-3xl shadow-2xl w-full aspect-[4/3] object-cover relative z-10" alt="Resort" />
                        ...
                        <div className="lg:w-1/2">
                            <span className="text-eling-red uppercase tracking-[0.3em] font-bold text-[10px] block mb-6">Discovery</span>
                            <h2 className="text-4xl font-bold mb-6 font-serif leading-tight text-gray-900">Eling Bening: Harmoni <br /> Keindahan Alam & Kemewahan</h2>
                            <p className="text-gray-500 text-base leading-relaxed mb-8">Eling Bening menghadirkan harmoni antara arsitektur modern yang elegan dengan ketenangan alam pegunungan Ambarawa. Destinasi yang dirancang untuk membangkitkan panca indera dan menenangkan jiwa.</p>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex items-center gap-3 text-xs font-bold text-gray-700 bg-gray-50 p-4 rounded-2xl border border-gray-100"><Mountain size={18} className="text-eling-green" /> Natural Vibes</div>
                                <div className="flex items-center gap-3 text-xs font-bold text-gray-700 bg-gray-50 p-4 rounded-2xl border border-gray-100"><Utensils size={18} className="text-eling-green" /> Fine Dining</div>
                            </div>
                        </div>
                    </div>
                </section>

                {/* Experiences / Gallery Section Stub */}
                <section className="py-24 px-8 bg-gray-50">
                    <div className="max-w-7xl mx-auto text-center mb-16">
                        <span className="text-eling-red uppercase tracking-[0.3em] font-bold text-[10px] block mb-6">Experience</span>
                        <h2 className="text-4xl font-bold font-serif text-gray-900">Moments to Remember</h2>
                    </div>
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[1, 2, 3].map(i => (
                            <div key={i} className="group relative h-80 rounded-3xl overflow-hidden shadow-xl border-4 border-white">
                                <img src={`/images/generated/event.png`} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Gallery" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-8">
                                    <p className="text-white font-bold text-sm tracking-widest uppercase">Eling Bening Resort</p>
                                </div>
                            </div>
                        ))}
                    </div>
        ...
        return (
            <div className="preview-container font-sans text-gray-900">
                ...
                <section className="relative h-[400px] flex items-center justify-center text-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-white max-w-4xl px-4">
                        <h1 className="text-5xl font-bold mb-6 font-serif">{a.heroTitle}</h1>
                        <p className="text-lg font-light tracking-wide italic opacity-90">{a.heroDesc}</p>
                    </div>
                </section>
                ...
                <section className="py-24 px-12 bg-white">
                    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="lg:w-1/2">
                            <span className="text-eling-red uppercase tracking-widest font-bold text-[10px] block mb-4">Sejarah & Visi</span>
                            <h2 className="text-4xl font-bold mb-8 leading-tight font-serif text-gray-900">{a.storyTitle}</h2>
                            <div className="space-y-6 text-gray-600 leading-relaxed text-base italic">
                                <p>{a.storyP1}</p>
                                <p>{a.storyP2}</p>
                            </div>
                        </div>
        ...
        return (
            <div className="preview-container font-sans text-gray-900">
                ...
                <section className="relative h-[400px] flex items-center justify-center text-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-white max-w-4xl px-4">
                        <h1 className="text-6xl font-bold mb-6 font-serif">{c.title}</h1>
                        <p className="text-lg font-light tracking-wide italic opacity-90">{c.subtitle}</p>
                    </div>
                </section>

                <section className="max-w-7xl mx-auto px-12 py-24 flex flex-col lg:flex-row gap-16">
                    <div className="lg:w-1/2">
                        <span className="text-eling-red uppercase tracking-widest font-bold text-[10px] block mb-4">Informasi Kontak</span>
                        <h2 className="text-4xl font-bold mb-12 font-serif text-gray-900">Sapa Kami Kapan Saja</h2>
                    ...
                    <div className="lg:w-1/2 bg-gray-50 border border-gray-200 shadow-xl rounded-3xl p-10 h-fit italic text-gray-400">
                        <div className="space-y-6">
                            ...
                            <div className="h-14 bg-eling-red opacity-80 rounded-xl" />
                        </div>
                    </div>
                </section>
            </div>
